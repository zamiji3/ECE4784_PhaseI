...
Vrest=-70; %mV
Cm=1.0; %uF/cm^2
Vm(1)=Vrest; %mV initial membrane voltage
...
for i=1:length(t)-1
    ...
    % Difference between the current m/n/h value and the next one
    ...
    % Derivative for membrane voltage and Euler method to find the next
    % voltage value
    dVm_dt= I_ion/Cm;
